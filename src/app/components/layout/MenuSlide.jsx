    ...
    <>
      ...
      >
        ...
        <div className="px-6 pb-6 pt-14 flex flex-col items-center relative w-full h-full overflow-y-auto">
          <Link
            href={usuario ? "/configuracoes" : "/login"}
            onClick={onClose}
            className=" w-full bg-tcc-azul-darker hover:bg-tcc-azul-dark py-3 px-4 rounded-xl flex justify-start items-center flex-col hover:brightness-110 transition-all "
          >
            <div className=" w-full flex py-1 justify-start items-center flex-row gap-3 ">
              {usuario?.urlImagem ? (
                <Image
              ...
              <div className="flex flex-col overflow-hidden">
                ...
                <h2 className="text-caption text-tcc-azul-light truncate">
                  {email}
                </h2>
              </div>
            </div>
          ...
          <div className="flex mt-6 flex-col gap-2.5 w-full items-center">
            <Link
              href="/"
              onClick={onClose}
              className="py-2.5 px-4 rounded-xl bg-tcc-azul-dark w-full flex justify-start items-center flex-row hover:brightness-110 transition-all gap-3"
            >
            ...
            <Link
              href="/sobre"
              onClick={onClose}
              className="mt-4 py-2.5 px-4 rounded-xl bg-tcc-azul-dark w-full flex justify-start items-center flex-row hover:brightness-110 transition-all gap-3"
            >
