    ...
    <div className="absolute top-full left-0 mt-2 w-72 bg-white rounded-xl shadow-2xl z-40 p-5 border border-gray-200">
      ...
      <div className="flex justify-between items-center mb-5">
        ...
        <button
          type="button"
          onClick={limparTudo}
          className="text-tcc-azul-light text-sm hover:underline"
        >
          Limpar tudo
        </button>
      </div>
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-gray-700 font-semibold mb-1.5 text-sm">Categorias</label>
          <div className="relative">
            <select
              className="w-full appearance-none bg-gray-50 border border-gray-300 rounded-lg py-2 px-3 text-gray-500 text-sm focus:outline-none focus:ring-2 focus:ring-tcc-laranja/20"
      ...
      <div className="flex gap-3 mt-8">
        ...
        <button
          ...
          className="flex-1 py-2 bg-tcc-laranja text-white rounded-lg font-semibold hover:opacity-90 transition-opacity"
        >
          Aplicar filtros
        </button>
      </div>
